...
def select_dc(dists):
    ...
    percent = 1.5
    position = int(np.ceil(N * (N - 1) * percent / 100))
...
if __name__ == "__main__":
    ...
    for xunhuan in range(10):
        txtDF1 = pd.read_csv(r'E:\Datasets\circles(0.1).csv')
        col = txtDF1.shape[1]
        ...
        dists = getDistanceMatrix(df_min_max, 0.1)
        dc = select_dc(dists)
    ...
    store1.to_csv(r'E:\Datasets\KROD-DPC_circles(0.1)(dc=1.5%,g=0.1).csv', index=False)